...
exports.logs = function(request, response){
	...
	// fs.writeFile('./logs/logi.json', JSON.stringify(aa), function(err){
	// 	if(err){
	// 		console.log("Huston mamy problem: " + err);
	// 	}
	// });

	//var ws2 = fs.createWriteStream('./logs/logi.json', {flags: 'w', mode: 0666});
	//ws2.write(JSON.stringify(aa));
	//ws.end();
